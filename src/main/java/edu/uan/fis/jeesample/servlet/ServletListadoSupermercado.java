...
@WebServlet("/ServletListadoSupermercado")
public class ServletListadoSupermercado extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println ("<div id='logo'><img src='images/canasta.png' alt='Logo' width='150'></div>");
